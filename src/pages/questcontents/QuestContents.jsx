...
// 모달데이터
const failData = [
  { title: "이런..! 틀렸어요!", message: "다시 시도해보세요.", imageSrc: '/assets/fail_image1.png' },
  { title: "이렇게까지 틀리기도 쉽지 않은데?", message: "다시 시도해보세요.", imageSrc: '/assets/fail_image2.png' },
  { title: "정답은커녕 근처도 못 갔네ㅋ", message: "다시 시도해보세요.", imageSrc: '/assets/fail_image3.png' },
  { title: "그걸 정답이라고 낸 거니?", message: "다시 시도해보세요.", imageSrc: '/assets/fail_image4.png' }
];
const successData = {
  title: "성공 ㅋㅋ 똥드셈",
  message: "ㅊㅋㅊㅋ",
...
function QuestContents() {
  ...
  const [modalProps, setModalProps] = useState({ title: '', message: '', imageSrc: null });
    ...
    const fetchQuestDetail = async () => {
      ...
      try {
        ...
        const response = await axios.get(
          `${BASE_URL}/api/quests/${questId}/solve`,
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (questType === 'short_answer') {
        ...
        submitUrl = `${BASE_URL}/api/quests/${questId}/answers`; 
        ...
        submitUrl = `${BASE_URL}/api/quests/${questId}/answers-images`;
      ...
      <main className="main-content">
        ...
        <div className="quest-container">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <button type="submit" className="quest-submit-button">제출</button>
          </form>
        </div>
      </main>
